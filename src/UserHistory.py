...
class StreamingHistory:
    def __init__(self, files: list, id=None):
        if id:
            self.id = id
        else:
            self.id = input("Enter Username: ")

        self.data = self.__prep_user_data(files)
        self.data_small = self.data[["trackName"]]
    ...
    def __prep_user_data(self, src):
        ...
        data = df[df["artistName"] != "Unknown Artist"]
    ...
    def get_user_data(self, context: str, ranks=20):
        df = self.data.copy()
...
if __name__ == "__main__":
    test = StreamingHistory(
        [
            "/Users/iansnyder/Desktop/Projects/Spotify_Proj/Data/MyData/StreamingHistory0.json",
            "/Users/iansnyder/Desktop/Projects/Spotify_Proj/Data/MyData/StreamingHistory1.json",
            "/Users/iansnyder/Desktop/Projects/Spotify_Proj/Data/MyData/StreamingHistory2.json",
            "/Users/iansnyder/Desktop/Projects/Spotify_Proj/Data/MyData/StreamingHistory3.json",
        ],
        id="idsnyder136",
    )
    test.run()

    # test.data_small.to_csv(
    # r"/Users/iansnyder/Desktop/Projects/Spotify_Proj/Data/input.txt", index=False
    # )
